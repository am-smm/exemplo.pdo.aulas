...
/** @var Projeto $elem */
$existe = Projeto::tryGetByID(getInput('id', 0), $elem);
$guardado = false;
...
<div class="container editar editar-projeto">
    ...
    if ( !$existe || $guardado): ?>
        <div class="row">
            <div class="col-sm-10 offset-sm-1 mb-3">
                <?php
                if ( !$existe): ?>
                    <div class="alert alert-danger" role="alert">Projeto inexistente.</div>
                <?php
                else: ?>
    ...
    <?php else: ?>
        ...
        <div class="row mb-4">
            <div class="col pag-title">Projeto <?= $elem->getNome() ?></div>
        </div>
